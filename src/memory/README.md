...
A basic implementation of persistent memory using a local knowledge graph. This lets Codex-based assistants remember information about the user across chats.
